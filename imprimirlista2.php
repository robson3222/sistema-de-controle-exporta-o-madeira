...
<h5>Embalagens de madeira não-conformes e não devolvidas após 30 dias de ocorrência.</h5>
<br>
<h5>Senhores Despachantes.</h5>
<br>
...
<table class="table">
  <thead>
    ...
    <th scope="col">Nofificado na Receita</th>  
    <th scope="col">Importador</th>
      ...
      <tr>
        <?php
          ...
          $sql = "SELECT * FROM `madeira` ORDER BY numeronfa asc";
...
<center>
<a href="imprimirlista2.php" role="button" class="btn btn-sm btn-primary">Voltar </a>
</center>
</div>
</div>

<script>
for (var i = 0; i < id_madeira.length; i++) {
  info += id_madeira[i] + ', ';
}
</script>
