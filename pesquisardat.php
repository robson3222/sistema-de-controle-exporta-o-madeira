...
<h1>Pesquisar</h1>
<form method="POST" action="pesquisardat.php">
    Pesquisar por nº nfa:<input type="text" name="pesquisar" placeholder="PESQUISAR">
...
$sql = "SELECT * FROM `madeira` WHERE numeronfa LIKE '%$pesquisar%' ";
